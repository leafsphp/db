...
class Db extends Db\Core
{
    ...
    {
        // cast the extracted value to a number when comparing against one
    ...
    {
        // PDO's own transaction handling works across mysql, sqlite,
        // postgres and sqlsrv — raw START TRANSACTION is mysql-only
        $this->connection($this->currentConnection)->beginTransaction();
    ...
    {
        $this->connection($this->currentConnection)->commit();
    ...
    {
        $this->connection($this->currentConnection)->rollBack();
